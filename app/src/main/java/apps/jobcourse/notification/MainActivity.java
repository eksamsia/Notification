package apps.jobcourse.notification;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateNotification(){
        ...
        Bitmap mascotBismap = BitmapFactory.decodeResource(getResources(), R.drawable.ic_mascot1);
        builder.setStyle(new NotificationCompat.BigPictureStyle().bigPicture(mascotBismap).
